...
$('input[name="sendButton"]').click(function(){
    ...
    request.done(function(res) {
        ...
        // НОВЫЕ ЭЛЕМЕНТЫ
        $('.itogo_ua_50000_10_36').text(res.itogo_ua_50000_10_36);
		$('.itogo_ua_50000_10_60').text(res.itogo_ua_50000_10_60);
		$('.itogo_ua_50000_15_36').text(res.itogo_ua_50000_15_36);
		$('.itogo_ua_50000_15_60').text(res.itogo_ua_50000_15_60);
		$('.itogo_ua_50000_22_36').text(res.itogo_ua_50000_22_36);
		$('.itogo_ua_50000_22_60').text(res.itogo_ua_50000_22_60);
		$('.don_ua_50000_10').text(res.don_ua_50000_10);
		$('.don_ua_50000_15').text(res.don_ua_50000_15);
		$('.don_ua_50000_22').text(res.don_ua_50000_22);
		$('.plat_ua_36m_10_50000').text(res.plat_ua_36m_10_50000);
		$('.plat_ua_60m_10_50000').text(res.plat_ua_60m_10_50000);
		$('.plat_ua_36m_15_50000').text(res.plat_ua_36m_15_50000);
		$('.plat_ua_60m_15_50000').text(res.plat_ua_60m_15_50000);
		$('.plat_ua_36m_22_50000').text(res.plat_ua_36m_22_50000);
		$('.plat_ua_60m_22_50000').text(res.plat_ua_60m_22_50000);
