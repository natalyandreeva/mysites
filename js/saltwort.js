// Тут собираем разные мелкие скрипты подключаемые к сайту

// Простая кросбраузерная функция добавления сайта в закладки
...
// Функция позволяющая добавлять класс и анимировать открытие accordion-group
...
// Функция которая вроде как должна печатать чистый лист при попытке распечатать страницу
<!--
