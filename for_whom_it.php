...
<title>Стоит ли брать кредит у частных инвесторов без залога. Кому подойдут наши кредитные программы</title>
</head><body id="for_whom_it" oncopy="return false;">
...
<center>
<div  class="shirina">
<h2>Кому могут быть интересны наши кредитные программы</h2>

	<p style="margin:5px 20px 0"><strong>Наши программы, вероятно, заинтересуют Вас по одной из ниже 
	перечисленных причин:</strong><br>- Вы не желаете &quot;светить&quot; кредит перед родственниками или знакомыми, 
	что неизбежно когда кредит берётся в банке "на себя";<br>- Вы не можете 
	&quot;светить&quot; кредит перед работодателем, налоговой или другим контролирующим Вас органом, 
	что также как правило неизбежно когда кредит берётся в банке &quot;на себя&quot;;<br>- Вы либо 
	НЕ 
	официально трудоустроены, либо предприниматель (фрилансер), либо временно 
	безработный;<br>- Вы труженик стоп - профессии (таксист, охранник и т.п.), а 
	значит, Вами &quot;брезгуют&quot; банки;<br>- Вам необходима 
	реструктуризация текущих кредитов;<br>- У Вас несколько (как правило более трёх) 
	мелких кредитов, что вызывает трудности с контролем их погашения. К тому 
	же мелкие кредиты, как правило дороже более крупных и выдаются на относительно 
	короткие сроки, так что &quot;перекредитация&quot; будет выгодной ввиду вероятного 
	уменьшения ежемесячных платежей;<br>- У Вас плохая кредитная история и на вас 
	&quot;висят&quot; безнадёжные кредиты, которые возможно уже даже проданы коллекторам. 
	Помимо того, что мы кредитуем данную категорию заёмщиков, мы ещё и 
	предлагаем им <a href="anticollektor.php">антиколекторскую 
	помощь</a> и помогаем избавиться от безнадёжных кредитов.</p>
		
<h2 style="margin:25px 0 0 0">Анонимный кредит</h2>

<p>Мы выдаём без залоговые кредиты и позиционируем их как анонимные для которых 
не только не нужны поручители, но и не нужно согласия работодателей, 
родственников, семьи и прочих третьих лиц и контролирующих органов. Даже в 
случае если заёмщик допускает просрочки - мы ни при каких обстоятельствах НЕ 
деанонимизируем информацию по кредиту перед третьими лицами которые изначально 
не были осведомлены лично Вами (например свидетели сделки с вашей стороны), ДО 
ТЕХ ПОР пока заёмщик находится с нами на связи. Если же заёмщик перестаёт 
выходить на связь и пропадает без вести, мы начинаем допускать, что с ним что-то 
случилось и начинаем "поиск" при котором естественно информация о кредите 
заёмщика скорее всего будет афишироваться.Тем не менее&nbsp; мы ни при каких 
обстоятельствах не передаём дело коллекторам которые как раз страдают тем, что 
помимо прочих методов воздействия, осуществляют давление через деанонимизацию 
факта выдачи кредита. Мы против коллекторов. <br>Однако очевидно, всё 
вышесказанное касается лишь гарантий анонимности с нашей стороны и не касается 
судовых инстанций и действий предпринимаемых ими, а также судебными приставами 
направленными на взыскание кредита по делу выигранному нами в суде с заёмщиками.</p>

<h2 style="margin:25px 0 0 0">Мы тоже иногда отказываем</h2>
	
	<p style="margin:5px 20px 0"><strong>Несмотря на то, что технически наша целевая аудитория - те кому 
	никто больше не даёт - мы тем не менее достаточно часто отказываем. Мы возможно откажем Вам как заёмщику если:</strong><br>
- Вы безработный и при этом не имеете нормального профильного образования;<br>- 
	...
	своих средств как минимум 50% от необходимых для его запуска и при этом 
	недостающая сумма не превышает суммы с которыми мы работаем;<br>
	- У Вас фальшивый паспорт или не вклеена свежая фотография (не обновлен 
	паспорт);<br>- У Вас нет прописки.</p>
	<p style="margin:5px 20px 0">Ну и естественно, мы точно откажем Вам если узнаем, что вы собираетесь взять 
	кредит и не планируете его отдавать ибо мы так НЕ работаем. Мы поможем вам получить кредит 
	у частного инвестора, но его нужно будет вернуть!


<p style="margin:5px 20px 0; padding-bottom:20px">Так или иначе, дабы не гадать, Вы можете <a href="/">подать онлайн заявку</a> и мы сообщим Вам о своём решении!</p>
</div>
</center>
